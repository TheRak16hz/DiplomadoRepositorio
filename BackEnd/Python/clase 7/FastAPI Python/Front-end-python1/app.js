...
//obtener y mostrar la lista de peliculas
...
async function agregarPelicula(event) {
    ...
    const method = pelicula_id ? "PUT" : "POST"; //determinar metodo. operador ternario
...
function editarPelicula(pelicula) {
    ...
    document.querySelector("button[type='submit']").textContent = "actualizar Pelicula"; //cambiar texto del boton
}
...
function limpiarFormulario() {
    ...
    document.getElementById("pelicula_id").value = ""; //limpiar el ID
    document.querySelector("button[type='submit']").textContent = "Agregar Pelicula"; //volver al texto original
}
