...
const elementoCodigo = document.querySelector("[name=cod_est]");
const elementoNombre = document.querySelector("[name=nom_est]");
const elementoDescripcion = document.querySelector("[name=des_est]");
const elementoEstatus = document.querySelector("[name=est_est]");
const elementoFkyPai = document.querySelector("[name=fky_pai]");
...
elementoFkyPai.addEventListener("blur", function (evento) {
    const Campo = evento.target;
    const valorSeleccionado = Campo.value;
...
formulario.addEventListener("submit", function (evento) {
    ...
    const datos = {
        cod_est: elementoCodigo.value.trim(),
        nom_est: elementoNombre.value.trim(),
        des_est: elementoDescripcion.value.trim(),
        est_est: elementoEstatus.value
    };
