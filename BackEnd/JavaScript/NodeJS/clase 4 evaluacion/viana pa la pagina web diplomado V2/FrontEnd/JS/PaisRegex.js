...
const elementoCodigoTel = document.querySelector("[name=cti_pai]");
const elementoEstatus = document.querySelector("[name=est_pai]");
const elementoFkyCon = document.querySelector("[name=fky_con]");
...
elementoFkyCon.addEventListener("blur", function (evento) {
    const Campo = evento.target;
    const valorSeleccionado = Campo.value; 
...
formulario.addEventListener("submit", function (evento) {
    ...
    if (!nombreValido || !aliasValido || !codigoTelValido || !estatusValido) {
